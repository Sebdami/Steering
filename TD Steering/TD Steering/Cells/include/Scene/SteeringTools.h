/***************************************************/
/* Nom:	SteeringTools.h
/* Description: SteeringTools
/* Auteur: DAMIENS Sebastien
/***************************************************/
#ifndef __SteeringTools_H_
#define __SteeringTools_H_

#include "Core\Scene.h"
#include "Scripts\CharacterController.h"
using namespace crea;

enum EnumSteeringCommandType
{
	Command_Invalid = -1,
	Command_Seek = 0,
	Command_Flee,
...
class SteeringTools
{
	...
	bool m_bCommand;
	EnumSteeringCommandType m_eCommandType;
